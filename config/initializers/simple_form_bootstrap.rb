...
SimpleForm.setup do |config|
  ...
  # small inline forms
  #
  # small inline default_wrapper
  config.wrappers :small_inline_form, class: "col-12" do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  # Small inline multi select
  config.wrappers :small_inline_multi_select, class: "row" do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: "col-sm-3 col-form-label small text-end p-0 lh-2"
    b.wrapper :grid_wrapper, class: "col-sm-9" do |ba|
      ba.wrapper class: "d-flex flex-row justify-content-between align-items-center" do |bb|
        bb.use :input, class: "form-select form-select-sm mx-1", error_class: "is-invalid", valid_class: "is-valid"
      end
      ba.use :full_error, wrap_with: {class: "invalid-feedback d-block"}
      ba.use :hint, wrap_with: {class: "form-text"}
    end
