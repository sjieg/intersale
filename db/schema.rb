...
ActiveRecord::Schema[7.1].define(version: 2023_11_05_151714) do
  ...
  create_table "collection_items", force: :cascade do |t|
    ...
    t.index ["availability"], name: "index_collection_items_on_availability"
    t.index ["collection_id"], name: "index_collection_items_on_collection_id"
    t.index ["title"], name: "index_collection_items_on_title"
  end
  ...
  create_table "user_collections", force: :cascade do |t|
    ...
    t.index ["role"], name: "index_user_collections_on_role"
